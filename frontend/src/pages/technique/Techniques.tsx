...
const columns = [
  ...
  { id: 'technique_type', label: '타입', minWidth: 100 },
  { id: 'weapon_type', label: '무기 타입', minWidth: 100 },
  { id: 'rank', label: '랭크', minWidth: 50 },
  { id: 'gauge_cost', label: '게이지 코스트', minWidth: 100 },
  { id: 'hitrange', label: '사거리', minWidth: 50 },
  { id: 'area', label: '범위', minWidth: 50 },
];
...
const Techniques: React.FC = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['techniques', page, rowsPerPage, name_search],
    queryFn: async () => {
  ...
  return (
    <Box sx={{ width: '100%', p: 3, height: 'calc(100vh - 100px)' }}>
      <Typography variant="h4" gutterBottom>테크닉</Typography>
