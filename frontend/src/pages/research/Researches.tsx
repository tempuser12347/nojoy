...
const columns = [
  ...
  { id: 'building_level', label: '건물 레벨', minWidth: 100 },
  { id: 'required_pages', label: '필요 페이지', minWidth: 100 },
];
...
const Researches: React.FC = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['researches', page, rowsPerPage, name_search],
    queryFn: async () => {
  ...
  return (
    <Box sx={{ width: '100%', p: 3, height: 'calc(100vh - 100px)' }}>
      <Typography variant="h4" gutterBottom>연구</Typography>
