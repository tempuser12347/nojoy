...
const SpecialEquipments: React.FC = () => {
  ...
  const columns = [
    ...
    { id: "ballistic_defense", label: "내탄방어", minWidth: 100 },
    { id: "fire_resistance", label: "내화방어", minWidth: 100 },
    { id: "firepower", label: "화력", minWidth: 100 },
    { id: "shoot_range", label: "사정거리", minWidth: 100 },
    { id: "shoot_area", label: "사정범위", minWidth: 100 },
    { id: "cooling_speed", label: "방열속도", minWidth: 100 },
    { id: "ramming", label: "충돌공격", minWidth: 100 },
    { id: "proximity_effect", label: "접현효과", minWidth: 100 },
