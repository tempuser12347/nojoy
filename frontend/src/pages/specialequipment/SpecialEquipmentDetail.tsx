...
export default function SpecialEquipmentDetail({ data }: { data?: SpecialEquipment }) {
  ...
  const stats = {
    ...
    "탄도학 방어": specialEquipment.ballistic_defense,
    "내화재": specialEquipment.fire_resistance,
    "화력": specialEquipment.firepower,
    "사정거리": specialEquipment.shoot_range,
    "사격 범위": specialEquipment.shoot_area,
    "냉각 속도": specialEquipment.cooling_speed,
    "충파": specialEquipment.ramming,
    "근접 효과": specialEquipment.proximity_effect,
