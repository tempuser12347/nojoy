...
const InstallationEffects: React.FC = () => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await api.get("/api/installationeffects", {
        params: {
          name_search,
          sort_by,
          sort_order,
  ...
  const columns = [
    ...
    { id: "description", label: "설명", minWidth: 300 },
    { id: "scope", label: "범위", minWidth: 100 },
  ];
...
export default InstallationEffects;